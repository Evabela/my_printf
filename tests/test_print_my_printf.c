...
Test(my_printf, one_argument, .init = redirect_all_std)
{
    char str[6] = "world";
...
Test(my_printf, more_argument, .init = redirect_all_std)
{
    int nb = 21;
...
Test(my_printf, lot_of_arguments_and_percentages, .init = redirect_all_std)
{
    char str[8] = "Epitech";
...
Test(my_printf, invalid_flag, .init = redirect_all_std)
{
    ...
    my_printf("The word %%%s%% has %k characters.\n", str);
    cr_assert_stdout_eq_str("The word %Epitech% has %k characters.\n");
}

Test(my_printf, percentage_alone, .init = redirect_all_std)
{
    char str[8] = "Epitech";

    my_printf("The word %%%s%% has % characters.\n", str);
